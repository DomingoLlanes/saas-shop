...
2. Then you'll have 3 apps available (2 APIs and 1 Frontend):
   1. [Mooc Backend](apps/marketplace/backend): http://localhost:8030/health-check
...
* [Mooc](src/Marketplace): Place to look in if you wanna see some code 🙂. Massive Open Online Courses public platform with users, videos, notifications, and so on.
...
You can see an example [here](src/Marketplace/Courses/Domain/CourseRepository.php)
and its implementation [here](src/Marketplace/Courses/Infrastructure/Persistence/DoctrineCourseRepository.php).

### Aggregates
You can see an example of an aggregate [here](src/Marketplace/Courses/Domain/Course.php). All aggregates should
